    ...
    return (
        <>
            ...
            <div className={styles.headercenter}>
                <input className={styles.headerCenterInput} type='text' placeholder="Search for stock images"></input>
                <SearchIcon></SearchIcon>
            </div>

            <div className='grid grid-cols-2 gap-3 mt-5 ' style={{ height: '250px', overflowY: 'scroll' }}>
                <div className={styles.customimg} style={{ backgroundColor: '#BA55D3', height: '100px', position: 'relative' }}>
                ...
                <div className={styles.customimg} style={{ backgroundColor: '#2E8B57', height: '100px', position: 'relative' }}>
                ...
                <div className={styles.customimg} style={{ backgroundColor: '#20B2AA', height: '100px', position: 'relative' }}>
                    <SportsFootballIcon style={{ position: 'absolute', zIndex: '1', color: '#7FFFD4	', fontSize: '100px' }}></SportsFootballIcon>
                    <p style={{ color: 'white', position: 'absolute', zIndex: '2' }} >Sports</p>
                </div>
                <div className={styles.customimg} style={{ backgroundColor: '#BA55D3', height: '100px', position: 'relative' }}>
